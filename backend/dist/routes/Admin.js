...
exports.router.get('/get-hotel/:hid', HotelController_1.getHotelControllerById);
...
exports.router.delete('/delete-hotel/:hid', AdminMiddleware_1.M_AdminMiddleware, HotelController_1.deleteHotelController);
// ROOM ----------------------------------------------------------------------------------------
exports.router.get('/get-room/:hid', AdminMiddleware_1.M_AdminMiddleware, RoomController_1.getRoomController);
exports.router.get('/get-room/:rid', AdminMiddleware_1.M_AdminMiddleware, RoomController_1.getRoomController);
exports.router.post('/add-room/:hid', cloudinary_1.upload.array('files', 5), AdminMiddleware_1.M_AdminMiddleware, RoomController_1.addRoomController);
exports.router.put('/update-room/:rid', cloudinary_1.upload.array('files', 5), AdminMiddleware_1.M_AdminMiddleware, RoomController_1.updateRoomController);
