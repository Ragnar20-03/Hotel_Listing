...
exports.router.get('/get-room/:hid', RoomController_1.getUserHotelRoomController);
...
exports.router.post('/cancel-book/:bid', UserMiddleware_1.M_UserMiddleware, BookingController_1.cancelUserBookingController);
